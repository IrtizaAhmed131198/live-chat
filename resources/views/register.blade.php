...
<body>
            ...
            <div class="authentication-inner">
                ...
                <div class="card px-sm-6 px-0">
                    <div class="card-body">
                        ...
                        <form id="formAuthentication" class="mb-6" action="{{ route('register.post') }}"
                            method="POST">
                            @csrf
                            <div class="mb-6 form-control-validation">
                                <label for="name" class="form-label">Full Name</label>
                                <input type="text" class="form-control @error('name') is-invalid @enderror"
                                    id="name" name="name" placeholder="Enter your full name" autofocus
                                    value="{{ old('name') }}" />
                                @error('name')
    ...
    <link rel="modulepreload" href="{{ asset('assets/js/popular-DHD2IDQ4.js') }}" />
    <link rel="modulepreload" href="{{ asset('assets/js/_commonjsHelpers-D6-XlEtG.js') }}" />
    <link rel="modulepreload" href="{{ asset('assets/js/bootstrap5-B8xweYSi.js') }}" />
    <link rel="modulepreload" href="{{ asset('assets/js/index-eQWVPmsa.js') }}" />
    <link rel="modulepreload" href="{{ asset('assets/js/auto-focus-gx3LVEfk.js') }}" />
    <script type="module" src="{{ asset('assets/js/popular-DHD2IDQ4.js') }}"></script>
    <script type="module" src="{{ asset('assets/js/bootstrap5-B8xweYSi.js') }}"></script>
    <script type="module" src="{{ asset('assets/js/auto-focus-gx3LVEfk.js') }}"></script><!-- END: Page Vendor JS-->
    <!-- BEGIN: Theme JS-->
    <link rel="modulepreload" href="{{ asset('assets/js/main-CGh5h70G.js') }}" />
    <script type="module" src="{{ asset('assets/js/main-CGh5h70G.js') }}"></script>
    <!-- END: Theme JS-->
    <!-- Pricing Modal JS-->
    <!-- END: Pricing Modal JS-->
    <!-- BEGIN: Page JS-->
    <link rel="modulepreload" href="{{ asset('assets/js/pages-auth-D0KVgRoL.js') }}" />
    <script type="module" src="{{ asset('assets/js/pages-auth-D0KVgRoL.js') }}"></script><!-- END: Page JS-->

    <!-- app JS -->
    <link rel="modulepreload" href="{{ asset('assets/js/app-T1DpEqax.js') }}" />
    <script type="module" src="{{ asset('assets/js/app-T1DpEqax.js') }}"></script><!-- END: app JS-->
</body>
