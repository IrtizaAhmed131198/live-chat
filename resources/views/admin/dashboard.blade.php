                    ...
                    <div class="col-md-6 col-xxl-4 mb-6">
                        <div class="card h-100 gap-12">
                            <div class="card-header d-flex justify-content-between">
                                ...
                                <div class="dropdown">
                                    <button class="btn p-0" type="button" id="salesActivity" data-bs-toggle="dropdown"
                                        aria-haspopup="true" aria-expanded="false">
                                        <i class="icon-base bx bx-dots-vertical-rounded icon-lg text-body-secondary"></i>
                                    </button>
                                    ...
                                    <div class="card-body">
                                        <div class="card-title d-flex align-items-start justify-content-between mb-4">
                                            <div class="avatar flex-shrink-0">
                                                <img src="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo/assets/img/icons/unicons/cube-secondary.png"
                                            ...
                                            <div class="d-flex flex-column">
                                                ...
                                                <div class="chart-statistics">
                                                    ...
                                                    <p class="text-success text-nowrap mb-0"><i
                                                            class="icon-base bx bx-chevron-up icon-lg"></i> +12.8%
                                                    </p>
                                                </div>
                                            </div>
                                        ...
                                        <ul class="p-0 m-0">
                                            <li class="d-flex align-items-center mb-7">
                                                <div class="avatar flex-shrink-0 me-3">
                                                    <img src="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo/assets/img/icons/unicons/oneplus.png"
                                                        alt="oneplus" />
                                                </div>
                                                <div
                                            ...
                                            <li class="d-flex align-items-center mb-7">
                                                <div class="avatar flex-shrink-0 me-3">
                                                    <img src="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo/assets/img/icons/unicons/watch-primary.png"
                                                        alt="smart band" />
                                                </div>
                                                <div
                                                    class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                            ...
                                            <li class="d-flex align-items-center mb-7">
                                                <div class="avatar flex-shrink-0 me-3">
                                                    <img src="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo/assets/img/icons/unicons/surface.png"
                                                        alt="Surface" />
                                                </div>
                                                <div
                                                    class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                            ...
                                            <li class="d-flex align-items-center mb-7">
                                                <div class="avatar flex-shrink-0 me-3">
                                                    <img src="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo/assets/img/icons/unicons/iphone.png"
                                                        alt="iphone" />
                                                </div>
                                                <div
                                                    class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                            ...
                                            <li class="d-flex align-items-center">
                                                <div class="avatar flex-shrink-0 me-3">
                                                    <img src="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo/assets/img/icons/unicons/earphone.png"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="card-body pt-6">
                                        <ul class="p-0 m-0">
                                            <li class="d-flex align-items-center mb-7">
                                                <div class="avatar flex-shrink-0 me-3">
                                                    <img src="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo/assets/img/icons/unicons/laptop-secondary.png"
                                            ...
                                            <li class="d-flex align-items-center mb-7">
                                                <div class="avatar flex-shrink-0 me-3">
                                                    <img src="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo/assets/img/icons/unicons/computer.png"
                                            ...
                                            <li class="d-flex align-items-center mb-7">
                                                <div class="avatar flex-shrink-0 me-3">
                                                    <img src="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo/assets/img/icons/unicons/watch.png"
                                            ...
                                            <li class="d-flex align-items-center mb-7">
                                                <div class="avatar flex-shrink-0 me-3">
                                                    <img src="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo/assets/img/icons/unicons/oneplus-success.png"
                                            ...
                                            <li class="d-flex align-items-center">
                                                <div class="avatar flex-shrink-0 me-3">
                                                    <img src="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo/assets/img/icons/unicons/pixel.png"
                    ...
                    <div class="col-md-6 col-xxl-4 mb-6">
                        <div class="card h-100">
                            <div class="card-header d-flex justify-content-between">
                                ...
                                <div class="dropdown">
                                    <button class="btn text-body-secondary p-0" type="button" id="earningReports"
                                        data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    ...
                                    <li class="d-flex mb-6 pb-1">
                                        ...
                                        <div
                                            ...
                                            <div class="user-progress"><span class="me-3">$1,619</span><i
                                                    class="icon-base bx bx-chevron-up text-success ms-1"></i>
                                                <span>18.6%</span>
                                            </div>
                                        </div>
                                    </li>
                    ...
                    <div class="col-md-6 col-xxl-4 mb-6">
                        <div class="card h-100">
                            <div class="card-header d-flex justify-content-between">
                                ...
                                <div class="dropdown">
                                    <button class="btn text-body-secondary p-0" type="button" id="salesByCountry"
                                        data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <i class="icon-base bx bx-dots-vertical-rounded icon-lg"></i>
                                    </button>
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-center align-items-center gap-4">
                                    <div class="d-flex align-items-center"><span
                                            class="badge badge-dot bg-success me-2"></span> Conversion Ratio
                                    </div>
                                    <div class="d-flex align-items-center"><span
                                            class="badge badge-dot bg-label-secondary me-2"></span> Total
                                        requirements</div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xxl-5 mb-xxl-0 mb-6">
                        <div class="card h-100">
                            <div class="card-header d-flex align-items-center justify-content-between">
                                ...
                                <div class="dropdown">
                                    <button class="btn text-body-secondary p-0" type="button" id="teamMemberList"
                                        data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <i class="icon-base bx bx-dots-vertical-rounded icon-lg"></i>
                                    </button>
                                ...
                                <table class="table table-borderless table-sm">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <div class="d-flex justify-content-start align-items-center">
                                                    <div class="avatar me-3">
                                                        <img src="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo/assets/img/avatars/17.png"
                                            ...
                                            <td><span class="badge bg-label-primary text-uppercase">Zipcar</span>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="badge bg-label-danger text-uppercase">Bitbank</span>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="badge bg-label-warning text-uppercase">Payers</span>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="badge bg-label-info text-uppercase">Brandi</span>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="badge bg-label-info text-uppercase">Crypter</span>
                                            </td>
                                ...
                                <table class="invoice-list-table table table-border-top-0">
                                    ...
                                    <tbody class="table-border-bottom-0">
                                        <tr>
                                            <td>
                                                <div class="d-flex justify-content-start align-items-center">
                                                    ...
                                                    <div class="d-flex flex-column">
                                                        <a href="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo-1/pages/profile-user"
                                            ...
                                            <td class="text-center"><img
                                                    src="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo/assets/img/icons/payments/master-dark.png"
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex justify-content-start align-items-center">
                                                    <div class="avatar-wrapper">
                                                        <div class="avatar avatar-sm me-2">
                                                            <img src="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo/assets/img/avatars/20.png"
                                                                alt="Avatar" class="rounded-circle" />
                                                        </div>
                                                    </div>
                                                    <div class="d-flex flex-column">
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="badge bg-label-warning"> Pending </span></td>
                                            <td class="text-center"><img
                                                    src="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo/assets/img/icons/payments/paypal_logo-dark.png"
                                                    class="img-fluid" width="29" alt="paypalCard"
                                                    data-app-light-img="icons/payments/paypal_logo-light.png"
                                                    data-app-dark-img="icons/payments/paypal_logo-dark.png"></td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="dropdown">
                                                        <a href="javascript:;" class="btn dropdown-toggle hide-arrow p-0"
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex justify-content-start align-items-center">
                                                    <div class="avatar-wrapper">
                                                        <div class="avatar avatar-sm me-2">
                                                            <img src="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo/assets/img/avatars/14.png"
                                                                alt="Avatar" class="rounded-circle" />
                                                        </div>
                                                    </div>
                                                    <div class="d-flex flex-column">
